/* ckwyp_nonstiff.f -- translated by f2c (version 20160102).
...
/* ----------------------------------------------------------------------C */
/*                                                                      C */
///* Subroutine */ int ckwyp_ns__(double *p, double *t, double *y,
//	double *diff, double *dt, long int *ickwrk, double *rckwrk,
//	 double *wdot)
//{
...
void getProblemSpecificRR(double rho, double t, double p,
    ...
    extern /* Subroutine */ int /*stif_(double *, double *, double *
                                  , double *, double *),*/ qssa_(double *, double *,
                                      double *), rdot_(double *, double *, double *),
        ratt_(double *, double *, double *, double *),
        ratx_(double *, double *, double *, double *,
