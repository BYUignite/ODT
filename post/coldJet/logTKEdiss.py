#centerline processing for logTKEdiss
...
def logTKEdiss(DI, profName="logTKEdiss"): 
    ...
    for it in range(ntimes) :
        print("logTKEdiss: time %i of %i" %(it+1, ntimes))
        cLine[it] = y[imid,it]
    ...
    if len(times) != ntimes :
        raise ValueError("lTKE_xD.py: wrong number of times in data file and in input file.")
