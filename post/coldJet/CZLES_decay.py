#scatter plots of the velocity decay rate (slope) vs. C/ZLES, C, and ZLES 
...
def CZLES_decay(DI): #uses list of cases

    cases=[]
    plotname="CZLES_decay"
    ...
    plt.scatter(CZLES[:,0], decay[:,0])
    plt.ylabel("velocity decay")
    plt.xlabel("$C/Z_{ZLES}$")
    plt.title("coldJet")
    
    #plt.savefig('../../data/plots_coldJet/'+plotname.replace(".","o"))
    plt.savefig('../../data/plots_coldJet/'+'CZLES_decay__ALL'.replace(".","o"))

#------------------------------------------------------------------------------------------------

def C_decay(DI): #uses list of cases
    ...
    plt.scatter(C_params[:,0], decay[:,0])
    plt.ylabel("velocity decay")
    plt.xlabel("$C$")
    plt.title("coldJet")
    
    #plt.savefig('../../data/plots_coldJet/'+plotname.replace(".","o"))
    plt.savefig('../../data/plots_coldJet/'+'C_decay__ALL'.replace(".","o"))
